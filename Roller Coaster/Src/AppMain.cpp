...
void AppMain::ChangeSpeedOfTrain( int val )
{
	...
	trainview->speed = float(val) / 100.0f;
}
...
//========================================================================
{
	...
	gluLookAt(matrix1_look.x, matrix1_look.y + 5, matrix1_look.z,
		matrix1_look.x + matrix4_look.x,
		matrix1_look.y + matrix4_look.y + 5,
		matrix1_look.z + matrix4_look.z,
		matrix2_look.x, matrix2_look.y + 5, matrix2_look.z);*/
}
